...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.addEventListener('input', function(e) {
    if (e.target.matches('#customMessage')) {
      ...
      if (document.getElementById('manualModeEmailCopy')?.style.display !== 'none') {
        generateManualEmailContent();
      }
    }
  });
  ...
  document.addEventListener('click', function(e) {
    ...
    if (e.target.matches('[data-action="markAsSentAndCreate"]') || 
    ...
    if (e.target.matches('#openMailClientBtn') || 
